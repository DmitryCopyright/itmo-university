...
public class App {
    ...
    private static String databaseUsername = "s335065";
    ...
    public static void main(String[] args) {
        ...
        CommandManager commandManager = new CommandManager(
                ...
                new HistoryCommand(),
                new SumOfStudentsCountCommand(collectionManager),
                new MaxByFormOfEducationCommand(collectionManager),
    ...
    private static boolean initialize(String[] args) {
        try {
            App.logger.info(Arrays.toString(args));
