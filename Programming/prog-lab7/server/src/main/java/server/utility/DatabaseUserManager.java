...
public class DatabaseUserManager {
        ...
        try {
            ...
            if (resultSet.next()) {
                user = new User(
                        ...
                        resultSet.getBytes(DatabaseHandler.USER_TABLE_PASSWORD_COLUMN)
                );
    ...
    public boolean checkUserByUsernameAndPassword(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            preparedSelectUserByUsernameAndPasswordStatement.setBytes(2, user.getPassword());
    ...
    public boolean insertUser(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            preparedInsertUserStatement.setBytes(2, user.getPassword());
