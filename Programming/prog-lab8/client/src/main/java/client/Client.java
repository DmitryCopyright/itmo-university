...
public class Client implements Runnable {
     ...
     * @return Collection.
     */
    public NavigableSet<StudyGroup> processRequestToServer(String commandName, String commandStringArgument,
        ...
        return serverResponse == null ? null : serverResponse.getStudyGroupCollection();
    }
