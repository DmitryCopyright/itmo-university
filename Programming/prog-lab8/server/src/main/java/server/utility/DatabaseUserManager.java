...
public class DatabaseUserManager {
    ...
    public boolean checkUserByUsernameAndPassword(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            preparedSelectUserByUsernameAndPasswordStatement.setBytes(2, messageDigest.digest(user.getPassword().getBytes()));
    ...
    public boolean insertUser(User user) throws DatabaseHandlingException {
        ...
        try {
            ...
            MessageDigest messageDigest = MessageDigest.getInstance("SHA-256");
            preparedInsertUserStatement.setBytes(2, messageDigest.digest(user.getPassword().getBytes()));
